"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\pc\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.373\\out\\buildHook\\index.js').default({tool: 'angular', checkSum: '20a86f97044f0e463fd597UAAYVBcGAg4NXlIHDAVQAlRRWgJQ', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/pc/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20a86f97044f0e463fd597UAAYVBcGAg4NXlIHDAVQAlRRWgJQ', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

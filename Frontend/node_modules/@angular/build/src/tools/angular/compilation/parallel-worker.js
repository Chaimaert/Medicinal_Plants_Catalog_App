"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\pc\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.376\\out\\buildHook\\index.js').default({tool: 'angular', checkSum: '20986a1e992916d4e54e9dCAAYUx9UCwNXWgQCVVBVAFVdX1Vd', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/pc/.vscode/extensions/wallabyjs.console-ninja-1.0.376/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20986a1e992916d4e54e9dCAAYUx9UCwNXWgQCVVBVAFVdX1Vd', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

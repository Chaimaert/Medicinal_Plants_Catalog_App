...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\pc\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.376\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20b6fe8a5df0cd31fc01caVxhfURZRD11TVlNTBQheW1EBU1Jb', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/pc/.vscode/extensions/wallabyjs.console-ninja-1.0.376/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20b6fe8a5df0cd31fc01caVxhfURZRD11TVlNTBQheW1EBU1Jb', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

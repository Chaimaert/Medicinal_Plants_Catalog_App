...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\pc\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.373\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20da99a832b33c11386991UU8ADU8ICVZWUlAGBFVRDgMKWwZT', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/pc/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20da99a832b33c11386991UU8ADU8ICVZWUlAGBFVRDgMKWwZT', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
